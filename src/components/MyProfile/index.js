...
class MyProfile extends Component {
  ...
  getMyProfile = async () => {
    ...
    const getFormattedData = data => ({
      ...
      profilePic:
        'https://res.cloudinary.com/djifdyfkd/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1734058077/Snapchat-997993417_ote0sq.jpg',
